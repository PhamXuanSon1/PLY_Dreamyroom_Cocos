    ...
    execute: function () {
      ...
      _export("OpenItem", OpenItem = (_dec = ccclass('OpenItem'), _dec2 = property({
        ...
        onItemPlaced() {
          ...
          var sr = this.getComponent(Sprite);
          if (sr) sr.spriteFrame = null;

          for (var n of this.open) if (n != null && n.isValid) n.active = true;

          for (var _n of this.close) if (_n != null && _n.isValid) _n.active = false;
        }
...
//# sourceMappingURL=108ae3d26e4d8e7b67517b156e152b4a16d7d014.js.map