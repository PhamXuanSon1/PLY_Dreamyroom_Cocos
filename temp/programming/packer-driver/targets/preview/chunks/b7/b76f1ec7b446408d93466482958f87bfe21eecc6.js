  ...
  return {
    ...
    execute: function () {
      ...
      _export("ChangeLight", ChangeLight = (_dec = ccclass('ChangeLight'), _dec2 = property({
        ...
        onDisable() {
          var i = ChangeLight.all.indexOf(this);
        ...
        onAnyItemPlaced() {
          ...
          var a = (_this$Item = this.Item1) == null ? void 0 : _this$Item.getComponent('ItemController');
          var b = (_this$Item2 = this.Item2) == null ? void 0 : _this$Item2.getComponent('ItemController');
          if (!a || !b) return;
        ...
        change() {
          ...
          var dst = this.getComponent(Sprite);
          var src = (_this$Img = this.Img2) == null ? void 0 : _this$Img.getComponent(Sprite);
...
//# sourceMappingURL=b76f1ec7b446408d93466482958f87bfe21eecc6.js.map