    ...
    execute: function () {
      ...
      _export("InputManager", InputManager = (_dec = ccclass('DreamyInputManager'), _dec2 = executeInEditMode(true), _dec3 = property({
        ...
        onTouchStart(ev) {
          ...
          var candidates = this.handlers.filter(h => h.node && h.node.isValid && h.node.activeInHierarchy && InputManager.isNodeInteractable(h.node) && h.hitTest(worldPos)).sort((a, b) => a.inputPriority - b.inputPriority || -InputManager.compareRenderOrder(a.node, b.node));
...
//# sourceMappingURL=fcee9e4388f03070d0ef153cd4fd53ec0148c743.js.map