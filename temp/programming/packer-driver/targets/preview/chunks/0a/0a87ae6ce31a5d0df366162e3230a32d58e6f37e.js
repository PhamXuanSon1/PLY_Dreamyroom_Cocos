    ...
    execute: function () {
      ...
      _export("PointerController", PointerController = (_dec = ccclass('PointerController'), _dec2 = property(Camera), _dec(_class = (_class2 = (_class3 = class PointerController extends Component {
        ...
        onTouchStart(event) {
          ...
          var slot = (_this$rayCastDetect = this.rayCastDetect(event.getLocation())) == null ? void 0 : _this$rayCastDetect.slot;
        ...
        rayCastDetect(pos, layer) {
          ...
          if (PhysicsSystem.instance.raycast(this.raycast)) {
            var result = PhysicsSystem.instance.raycastResults;

            for (var i = 0; i < result.length; i++) {
              var slot = result[i].collider.node;
              var hitPoint = result[i].hitPoint;
...
//# sourceMappingURL=0a87ae6ce31a5d0df366162e3230a32d58e6f37e.js.map