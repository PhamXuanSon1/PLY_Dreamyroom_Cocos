System.register(["__unresolved_0", "cc", "cc/env", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, input, Input, Vec3, Vec2, UITransform, Layers, EDITOR, ItemGraphic, ItemManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _class3, _crd, ccclass, property, executeInEditMode, Ed, InputPriority, InputManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "f7ad4CQqd5ArYyLlhPKnxVG", "InputManager", undefined);
      /**
      ...
      _export("InputManager", InputManager = (_dec = ccclass('DreamyInputManager'), _dec2 = executeInEditMode(true), _dec3 = property({
        type: Node,
        tooltip: 'Node chứa lớp kéo (item đang cầm sẽ tạm nằm dưới đây để nổi lên trên cùng).\n' + 'Để trống = tự dò / dùng chính node này.'
      }), _dec4 = property({
        type: Layers.Enum,
        tooltip: 'Chọn Layer bạn muốn gán (DEFAULT, UI_2D, UI_3D hoặc bất kỳ custom layer nào trong Project Settings).'
      }), _dec5 = property({
        type: [Node],
        tooltip: 'Danh sách các Node cần áp dụng Layer (để trống = áp dụng cho chính node này và toàn bộ con).'
      }), _dec6 = property({
        tooltip: 'Tick để gán Layer đã chọn ở trên cho toàn bộ cây node con'
      }), _dec7 = property({
        ...
        constructor() {
          ...
          // ---- Cấu hình Layer tuỳ chỉnh ----
          _initializerDefineProperty(this, "customLayer", _descriptor2, this);

          _initializerDefineProperty(this, "targetRoots", _descriptor3, this);
        ...
        /** Gán Layer tuỳ chọn cho toàn bộ các node con đệ quy */


        setupAllLayers() {
          var roots = this.targetRoots && this.targetRoots.length > 0 ? this.targetRoots : [this.node];
          var targetLayer = this.customLayer;
          var count = 0;

          var applyRecursive = n => {
          ...
          console.log("[DreamyInputManager] \u0110\xE3 g\xE1n Layer (" + targetLayer + ") cho " + count + " node.");
        ...
        static unregisterPinch(h) {
          var m = InputManager.instance;
          if (!m) return;
          var i = m.pinchHandlers.indexOf(h);
        ...
        onTouchStart(ev) {
          ...
          var worldPos = InputManager.toWorld(ev); // Broadcast: ItemManager cần biết mọi lần chạm (reset idle timer, first-click,
          ...
          var candidates = this.handlers.filter(h => h.node && h.node.isValid && h.node.activeInHierarchy && h.hitTest(worldPos)).sort((a, b) => a.inputPriority - b.inputPriority || -InputManager.compareRenderOrder(a.node, b.node));

          for (var h of candidates) {
        ...
        onTouchMove(ev) {
          ...
          var touches = (_ev$getAllTouches2 = ev.getAllTouches()) != null ? _ev$getAllTouches2 : [];
          ...
          (_this$captor$onPointe = (_this$captor = this.captor).onPointerMove) == null ? void 0 : _this$captor$onPointe.call(_this$captor, InputManager.toWorld(ev), ev);
        }
        ...
        handlePinch(touches) {
          ...
          var a = touches[0].getUILocation();
          var b = touches[1].getUILocation();
          ...
          if (this.lastPinchDistance >= 0) {
            ...
            if (Math.abs(delta) > 0.01) {
              for (var h of this.pinchHandlers) h.onPinch(delta);
            }
          }
        ...
        static toWorld(ev) {
          ...
          var p = ev.getUILocation();
          return new Vec3(p.x, p.y, 0);
        }
        /** Thay cho Physics.RaycastAll — hit-test AABB trong UI space. */
        ...
        static compareRenderOrder(a, b) {
          var pa = InputManager.siblingPath(a);
          var pb = InputManager.siblingPath(b);
        ...
        static siblingPath(node) {
          ...
          for (var n = node; n && n.parent; n = n.parent) {
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "customLayer", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "targetRoots", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _applyDecoratedDescriptor(_class2.prototype, "applyLayerNow", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "applyLayerNow"), _class2.prototype), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "verbose", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=ca4551c596ad303d2a24af1f322f31005e45bcea.js.map