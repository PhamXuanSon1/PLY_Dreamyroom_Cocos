System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Vec3, math, input, Input, InputManager, InputPriority, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _crd, ccclass, property, BaseRoom;
  ...
  function _reportPossibleCrUseOfIPinchHandler(extras) {
    _reporterNs.report("IPinchHandler", "../core/InputManager", _context.meta, extras);
  }
    ...
    execute: function () {
      ...
      _export("BaseRoom", BaseRoom = (_dec = ccclass('BaseRoom'), _dec2 = property({
        ...
        onEnable() {
          ...
          (_crd && InputManager === void 0 ? (_reportPossibleCrUseOfInputManager({
            error: Error()
          }), InputManager) : InputManager).registerPinch(this);
        ...
        onDisable() {
          ...
          (_crd && InputManager === void 0 ? (_reportPossibleCrUseOfInputManager({
            error: Error()
          }), InputManager) : InputManager).unregisterPinch(this);
        ...
        onPointerMove(worldPos, _ev) {
          ...
          var diffX = worldPos.x - this.dragStartWorld.x;
          var target = new Vec3(this.roomStartPosition.x + diffX * this.panSpeed, this.roomStartPosition.y, this.roomStartPosition.z);
        ...
        clampPosition(position) {
          ...
          var left = (_this$leftLimitPos = this.leftLimitPos) == null ? void 0 : _this$leftLimitPos.worldPosition.x;
          var right = (_this$rightLimitPos = this.rightLimitPos) == null ? void 0 : _this$rightLimitPos.worldPosition.x;
...
//# sourceMappingURL=fb2b440b20a33bc9c150953db9731f4c85ceda2f.js.map