System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, input, Input, Vec3, Vec2, UITransform, ItemGraphic, ItemManager, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _class3, _crd, ccclass, property, InputPriority, InputManager;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'input', 'Input', 'EventTouch', 'Vec3', 'Vec2', 'UITransform']);
      ...
      _export("InputManager", InputManager = (_dec = ccclass('DreamyInputManager'), _dec2 = property({
        type: Node,
        tooltip: 'Node chứa lớp kéo (item đang cầm sẽ tạm nằm dưới đây để nổi lên trên cùng).\n' + 'Với Level542 hãy kéo node "Items" vào đây. Để trống = tự dò (cha của cha item).'
      }), _dec3 = property({
        tooltip: 'In log chi tiết mỗi lần bắt/nhả sự kiện'
      }), _dec(_class = (_class2 = (_class3 = class InputManager extends Component {
        constructor() {
          super(...arguments);

          _initializerDefineProperty(this, "dragLayerRoot", _descriptor, this);

          _initializerDefineProperty(this, "verbose", _descriptor2, this);
        ...
        onLoad() {
          ...
          if (this.dragLayerRoot) (_crd && ItemGraphic === void 0 ? (_reportPossibleCrUseOfItemGraphic({
            error: Error()
      ...
      }, _class3.canInput = true, _class3.instance = null, _class3), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "dragLayerRoot", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "verbose", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=bf4dee05701369db5e4d8aff415072aca4ad78b0.js.map