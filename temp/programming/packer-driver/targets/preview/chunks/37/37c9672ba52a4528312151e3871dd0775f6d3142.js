System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "88586tYhwBMyKXkNbfFTQZJ", "DreamyInputManager", undefined);
      /**
      ...
      _export("DreamyInputManager", DreamyInputManager = (_dec = ccclass('DreamyInputManager'), _dec2 = executeInEditMode(true), _dec3 = property({
        ...
        static isNodeInteractable(node) {
          ...
          var m = DreamyInputManager.instance;
        ...
        onTouchStart(ev) {
          ...
          var worldPos = DreamyInputManager.toWorld(ev); // Broadcast: ItemManager cần biết mọi lần chạm (reset idle timer, first-click,
          ...
          (_instance = (_crd && ItemManager === void 0 ? (_reportPossibleCrUseOfItemManager({
            error: Error()
          }), ItemManager) : ItemManager).instance) == null || _instance.onAnyPointerDown();
          var candidates = this.handlers.filter(h => h.node && h.node.isValid && h.node.activeInHierarchy && DreamyInputManager.isNodeInteractable(h.node) && h.hitTest(worldPos)).sort((a, b) => a.inputPriority - b.inputPriority || -DreamyInputManager.compareRenderOrder(a.node, b.node));
        ...
        onTouchMove(ev) {
          ...
          (_this$captor$onPointe = (_this$captor = this.captor).onPointerMove) == null || _this$captor$onPointe.call(_this$captor, DreamyInputManager.toWorld(ev), ev);
        }
        ...
        onTouchEnd(ev) {
          ...
          var c = this.captor;
          this.captor = null;
          c == null || c.onPointerUp == null || c.onPointerUp(DreamyInputManager.toWorld(ev), ev);
        ...
        cancelCaptor() {
          ...
          var c = this.captor;
          this.captor = null;
          if (c) (_ref = (_c$onPointerCancel = c.onPointerCancel) != null ? _c$onPointerCancel : c.onPointerUp) == null || _ref.call(c, c.node.worldPosition, undefined);
        } // ------------------------------------------------------------ helper
        ...
        static compareRenderOrder(a, b) {
          var pa = DreamyInputManager.siblingPath(a);
          var pb = DreamyInputManager.siblingPath(b);
...
//# sourceMappingURL=37c9672ba52a4528312151e3871dd0775f6d3142.js.map