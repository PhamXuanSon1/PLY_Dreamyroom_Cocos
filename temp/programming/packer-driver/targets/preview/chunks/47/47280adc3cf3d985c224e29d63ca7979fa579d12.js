    ...
    execute: function () {
      ...
      _export("ItemGraphic", ItemGraphic = (_dec = ccclass('ItemGraphic'), _dec2 = property({
        ...
        bringToFront() {
          ...
          var layer = this.resolveDragLayer();
          if (!layer) return;
        ...
        resolveDragLayer() {
          ...
          var root = ItemGraphic.dragLayerRoot && ItemGraphic.dragLayerRoot.isValid ? ItemGraphic.dragLayerRoot : (_this$node$parent$par = (_this$node$parent = this.node.parent) == null ? void 0 : _this$node$parent.parent) != null ? _this$node$parent$par : null;
          if (!root) return null;
          var layer = root.getChildByName(DRAG_LAYER_NAME);
        ...
        handleTargetSprites(targetPoint, isShadowEnabled) {
          if (isShadowEnabled === void 0) {
            isShadowEnabled = true;
          }

          if (!targetPoint) return;
          this.hiddenTargetSprites.length = 0;
          var sprites = targetPoint.getComponentsInChildren(Sprite);

          for (var sr of sprites) {
        ...
        restoreTargetSprites() {
          for (var sr of this.hiddenTargetSprites) {
        ...
        getCombinedBounds() {
          var uts = this.node.getComponentsInChildren(UITransform);
          if (uts.length === 0) return null;
          var box = null;

          for (var ut of uts) {
            var b = ut.getBoundingBoxToWorld();
...
//# sourceMappingURL=47280adc3cf3d985c224e29d63ca7979fa579d12.js.map