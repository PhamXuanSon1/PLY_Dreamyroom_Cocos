    ...
    execute: function () {
      ...
      _export("MainCamera", MainCamera = (_dec = ccclass('MainCamera'), _dec2 = property(Camera), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = class MainCamera extends Component {
        ...
        moveTo(node, dt) {
          ...
          var target = this.node.worldPosition; // console.log(pos, target);

          var diff = pos.clone().subtract(target);
...
//# sourceMappingURL=e97b2134ad17cb7666d3291e48d731708c9f6a04.js.map