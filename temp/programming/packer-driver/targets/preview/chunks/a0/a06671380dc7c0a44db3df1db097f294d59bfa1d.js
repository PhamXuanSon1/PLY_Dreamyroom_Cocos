System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfipm(extras) {
    _reporterNs.report("ipm", "../MyScript/core/InputManager", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _export("UI", UI = (_dec4 = ccclass('UI'), _dec5 = property(Camera), _dec6 = property(Camera), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(BindingUI), _dec11 = property(BindingUI), _dec12 = property(BindingUI), _dec13 = property(BindingUI), _dec14 = property([BindingUI]), _dec15 = property([Node]), _dec16 = property([Node]), _dec17 = property([Node]), _dec18 = property([Node]), _dec19 = property([Node]), _dec20 = property([Node]), _dec21 = property([Node]), _dec22 = property([Node]), _dec4(_class4 = (_class5 = class UI extends Component {
        ...
        bind() {
          var pos = this.uiCam.node.position.clone();
          {
          ...
          this.bindings.forEach(bind => {
            bind.binds.forEach(item => {
              ...
              var lpos = item.parent.inverseTransformPoint(v3(), pos);
              item.position = lpos;
            });
          });
        }
        ...
        moveHand() {
          ...
          this.hTween = tween({
            ...
            var hand = this.hand;
            var child = this.hand.children[0].getComponentInChildren(Sprite);
            child.color = new Color(255, 255, 255, 255); // child.node.scale = v3(1, 1, 1).multiplyScalar(2);

            var pos = this.endHand.getWorldPosition();
            var delta = this.hand.worldPosition.clone().subtract(pos);

            if (this.moveDir == 0) {
              var p = v3(pos.x, this.hand.worldPosition.y, this.hand.worldPosition.z);
              var time = delta.length() * 0.5;
              ...
              var _p = v3(pos.x, pos.y, pos.z);

              var _time = delta.length() / 1000;

              this.hTween = tween(this.hand).delay(0.2).to(_time, {
                worldPosition: _p
              }, {
                easing: 'smooth',
...
//# sourceMappingURL=a06671380dc7c0a44db3df1db097f294d59bfa1d.js.map