System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "cc/env"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, misc, Node, tween, v3, Thing, Slot, ipm, ui, cEasing, sm, SoundType, EDITOR, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _crd, ccclass, property, executeInEditMode, room, Items, Loaded, Room;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Items", Items = [[0, 0, 0], [1, 1, 1], [2, 2, 2], [3, 3, 3], [4, 4, 4], [5, 5, 5], [6, 6, 6], [7, 7, 7], [8, 8, 8], [8, 8, 8], [9, 9, 9], [10, 10, 10], [11, 11, 11], [12, 12, 12], [13, 13, 13], [14, 14, 14], [15, 15, 15]]);
      ...
      _export("Room", Room = (_dec = ccclass('Room'), _dec2 = executeInEditMode(true), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property([Node]), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec(_class = _dec2(_class = (_class2 = class Room extends Component {
        ...
        moved() {
          ...
          if (this.tappable) {
            ...
            if (emptyBox.length == 1) {// sm.playSound(SoundType.Alert)
        ...
        onTouchMove(event) {
          ...
          tp.y = misc.clampf(tp.y, -maxY - 100, maxY);
          (_crd && ui === void 0 ? (_reportPossibleCrUseOfui({
            error: Error()
          }), ui) : ui).keepTap();
...
//# sourceMappingURL=e26a30af4e3b12bca052152b867096100a8073ef.js.map