System.register(["cc", "cc/env"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'UITransform', 'Sprite', 'SpriteFrame', 'Color', 'Vec3', 'JsonAsset', 'resources', 'CCClass', 'js', 'Size', 'sp', 'assetManager']);
      ...
      _export("SceneBuilder", SceneBuilder = (_dec = ccclass('SceneBuilder'), _dec2 = executeInEditMode(true), _dec3 = menu('Pipeline/SceneBuilder'), _dec4 = property({
        ...
        tooltip: 'Thư mục sprite TRONG assets/resources/ (không có dấu / ở cuối, không kèm chữ resources/)'
      }), _dec6 = property({
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "spriteDir", _descriptor2, this);

          _initializerDefineProperty(this, "applySorting", _descriptor3, this);

          _initializerDefineProperty(this, "verbose", _descriptor4, this);

          _initializerDefineProperty(this, "buildOnStart", _descriptor5, this);
        ...
        build() {
          ...
          return _asyncToGenerator(function* () {
            ...
            console.log("[SceneBuilder] D\u1EF1ng xong \"" + data.meta.scene + "\"" + ("" + (data.meta.exportRoot ? " (nh\xE1nh " + data.meta.exportRoot + ")" : '')) + (": " + _this.nodeMap.size + " node, K=" + K));
        ...
        loadFramesFromResources() {
          return new Promise(resolve => {
            resources.loadDir(this.spriteDir, SpriteFrame, (err, assets) => {
              if (err) {
              ...
              console.log("[SceneBuilder] \u0110\xE3 load " + assets.length + " SpriteFrame t\u1EEB resources/" + this.spriteDir);
              resolve();
            });
          });
        }
        ...
        loadFramesFromAssetDb() {
          ...
          return _asyncToGenerator(function* () {
            ...
            var pattern = "db://assets/resources/" + _this2.spriteDir + "/**/*";
            var infos = [];
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "spriteDir", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "applySorting", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "verbose", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "buildOnStart", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _applyDecoratedDescriptor(_class2.prototype, "buildNow", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "buildNow"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "clearBuilt", [_dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "clearBuilt"), _class2.prototype)), _class2)) || _class) || _class) || _class));
...
//# sourceMappingURL=d05bb58e612bc1ae31fd2275d517c3c2ae7b2fb4.js.map