System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      PoolAmount = (_dec = ccclass('PoolAmount'), _dec2 = property({
        type: PoolType
      ...
      _export("Ply_Pool", Ply_Pool = (_dec5 = ccclass('Ply_Pool'), _dec6 = property([PoolAmount]), _dec5(_class4 = (_class5 = (_class6 = class Ply_Pool extends (_crd && Ply_Singleton === void 0 ? (_reportPossibleCrUseOfPly_Singleton({
        ...
        onInit() {
          for (var i = 0; i < this.poolAmounts.length; i++) {
            var poolAmount = this.poolAmounts[i]; // Neu chua co danh sach cho loai pool nay, tao mot danh sach moi
            ...
            for (var j = 0; j < poolAmount.amount; j++) {
              if (!poolAmount.prefab) continue;
              var unitNode = instantiate(poolAmount.prefab);
              unitNode.active = false;
              unitNode.setParent(this.node);
              var gameUnit = unitNode.getComponent(_crd && Ply_GameUnit === void 0 ? (_reportPossibleCrUseOfPly_GameUnit({
                error: Error()
        ...
        spawn(poolType, pos, rot) {
          if (rot === void 0) {
            rot = new Quat();
          }

          var queue = this.dict.get(poolType); // Lay danh sach game unit tu pool

          var gameUnit = null; // Khai bao bien gameUnit de luu ket qua
          ...
          if (queue && queue.length > 0) {
            ...
            var unitNode = instantiate(prefab);
            unitNode.setParent(this.node);
...
//# sourceMappingURL=b2313915bbb0c3c3e2e60437e4a9281ad8d63418.js.map