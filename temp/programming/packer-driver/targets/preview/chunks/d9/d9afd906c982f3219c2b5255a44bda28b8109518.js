System.register(["__unresolved_0", "cc", "cc/env", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, UITransform, Sprite, SpriteFrame, Color, Vec3, JsonAsset, resources, CCClass, js, Size, sp, assetManager, Asset, EDITOR, MaterialType, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, executeInEditMode, menu, Ed, SceneBuilder;
  ...
  function _reportPossibleCrUseOfMaterialType(extras) {
    _reporterNs.report("MaterialType", "../item/ItemController", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      MaterialType = _unresolved_2.MaterialType;
    }],
    execute: function () {
      _crd = true;
        ...
        loadFramesFromAssetDb() {
          ...
          return _asyncToGenerator(function* () {
            ...
            yield Promise.all(infos.map(info => new Promise(resolve => {
              ...
              var key = SceneBuilder.keyFromAssetPath((_ref = (_info$url = info.url) != null ? _info$url : info.path) != null ? _ref : '');
              assetManager.loadAny({
                uuid: info.uuid
              }, (err, asset) => {
                if (!err && asset) {
                  if (key) _this2.frames.set(key, asset);
                  if (asset.name) _this2.frames.set(asset.name, asset);
                  if (info.name && info.name !== 'spriteFrame') _this2.frames.set(info.name, asset);
                }
...
//# sourceMappingURL=d9afd906c982f3219c2b5255a44bda28b8109518.js.map