    ...
    execute: function () {
      ...
      _export("ItemMovement", ItemMovement = (_dec = ccclass('ItemMovement'), _dec2 = property({
        ...
        startDragAnimation() {
          ...
          this.isScaling = true;
          var target = ItemMovement.enableDragScale ? new Vec3(this.originalScale.x * ItemMovement.dragScaleAmount, this.originalScale.y * ItemMovement.dragScaleAmount, this.originalScale.z * ItemMovement.dragScaleAmount) : this.originalScale.clone();
        ...
        moveToTarget(target, duration, onComplete) {
          var dest = target.worldPosition.clone();
...
//# sourceMappingURL=d39a6a57e19401dda09eb2471b4915fcd386b42f.js.map