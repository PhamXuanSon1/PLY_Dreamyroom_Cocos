    ...
    execute: function () {
      ...
      _export("BoxController", BoxController = (_dec = ccclass('BoxController'), _dec2 = property({
        ...
        onLoad() {
          ...
          (_this$boxGraphic = this.boxGraphic) == null ? void 0 : _this$boxGraphic.changeState((_crd && BoxState === void 0 ? (_reportPossibleCrUseOfBoxState({
            error: Error()
        ...
        onClick() {
          ...
          (_instance = (_crd && SoundManager === void 0 ? (_reportPossibleCrUseOfSoundManager({
            error: Error()
          }), SoundManager) : SoundManager).instance) == null ? void 0 : _instance.playFx((_crd && FxType === void 0 ? (_reportPossibleCrUseOfFxType({
            error: Error()
          ...
          (_instance2 = (_crd && UIManager === void 0 ? (_reportPossibleCrUseOfUIManager({
            error: Error()
          }), UIManager) : UIManager).instance) == null ? void 0 : _instance2.activateGameLogoAndPlaynow();
          ...
          if (!this.finishedTutorial) {
            ...
            (_this$boxGraphic2 = this.boxGraphic) == null ? void 0 : _this$boxGraphic2.changeState((_crd && BoxState === void 0 ? (_reportPossibleCrUseOfBoxState({
              error: Error()
            ...
            (_this$handOfBox = this.handOfBox) == null ? void 0 : _this$handOfBox.moveAfterIntro(1.2);
            ...
            var finish = () => {
              ...
              this.isClicked = false;
              (_this$boxGraphic3 = this.boxGraphic) == null ? void 0 : _this$boxGraphic3.setAutoOpenEnabled(true);
            };
          ...
          (_this$boxGraphic4 = this.boxGraphic) == null ? void 0 : _this$boxGraphic4.changeState((_crd && BoxState === void 0 ? (_reportPossibleCrUseOfBoxState({
            error: Error()
        ...
        spawnItem() {
          ...
          var currentItem = im.getCurrentItem();
          ...
          var pop = im.enablePopScale ? im.popScaleAmount : 1;
          currentItem.setScale(pop, pop, pop);
          var itemScript = currentItem.getComponent(_crd && ItemController === void 0 ? (_reportPossibleCrUseOfItemController({
            error: Error()
          }), ItemController) : ItemController);
          itemScript == null ? void 0 : (_itemScript$itemGraph = itemScript.itemGraphic) == null ? void 0 : _itemScript$itemGraph.bringToFront();
          currentItem.setRotationFromEuler(0, 0, randomRange(-90, 90));
          var holder = im.getCurrentHolder();
          if (!holder) return;
          var holderSlot = holder.getComponent(_crd && HolderSlot === void 0 ? (_reportPossibleCrUseOfHolderSlot({
            error: Error()
...
//# sourceMappingURL=614c58314b3e713163270e50b530a43ad359d629.js.map