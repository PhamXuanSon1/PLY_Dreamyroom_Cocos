    ...
    execute: function () {
      ...
      _export("Black", Black = (_dec = ccclass('Black'), _dec2 = property(Mask), _dec3 = property([Vec3]), _dec4 = property(Sprite), _dec5 = property(Size), _dec6 = property({
        ...
        setMask(points) {
          ...
          if (this.isRevert) {
            ...
            if (this.fill > 0.5) {
              ...
              var _d = this.fill - _dF;

              this.sprite.node.position = v3(0, this.diagonal * _d, 0);
            }
          }
        ...
        addSprite(sprite, rotation) {
          ...
          this.sprite = sprite;
          var dRot = sprite.node.worldRotation.clone();
        ...
        setFill(begin, end, ratio) {
          ...
          this.end = end;
          this.fill = ratio;
          var r = lerp(begin, end, ratio);
          var bl = v2(-1, -1);
          var br = v2(1, -1);
          var tr = v2(1, 1);
          var tl = v2(-1, 1);
          var leftLerp = Vec2.lerp(v2(), bl, tl, r);
          var rightLerp = Vec2.lerp(v2(), br, tr, r);
          var p = [bl, br, rightLerp, leftLerp];
          ...
          {
            var bl3 = v3(points[0].x, points[0].y - this.diagonal, 0);
            var br3 = v3(points[1].x, points[1].y - this.diagonal, 0);
            points[0] = bl3;
            points[1] = br3;
          }
          this.setMask(points);
...
//# sourceMappingURL=317b396260592ea64b1f3ca2d8e9ef4cd2be9c52.js.map