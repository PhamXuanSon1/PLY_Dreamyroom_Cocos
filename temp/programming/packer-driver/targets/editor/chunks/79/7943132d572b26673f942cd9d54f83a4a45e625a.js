      ...
      _export("BlinkEffect", BlinkEffect = (_dec = ccclass('BlinkEffect'), _dec(_class = class BlinkEffect extends Component {
        ...
        deSpawn() {
          ...
          (_instance = (_crd && ObjectPool === void 0 ? (_reportPossibleCrUseOfObjectPool({
            error: Error()
          }), ObjectPool) : ObjectPool).instance) == null ? void 0 : _instance.despawn((_crd && PoolType === void 0 ? (_reportPossibleCrUseOfPoolType({
            error: Error()
...
//# sourceMappingURL=7943132d572b26673f942cd9d54f83a4a45e625a.js.map