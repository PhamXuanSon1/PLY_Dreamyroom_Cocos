System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Animation, color, Enum, instantiate, Layers, Node, sp, Sprite, tween, UIRenderer, UITransform, v3, PoolMember, room, Ulis, ui, SoundType, ipm, NodeOrder, _dec, _dec2, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, executeInEditMode, Thing;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      SoundType = _unresolved_6.SoundType;
    }, function (_unresolved_7) {
      ipm = _unresolved_7.ipm;
    }, function (_unresolved_8) {
      NodeOrder = _unresolved_8.NodeOrder;
    }],
    execute: function () {
      _crd = true;
      ...
      __checkObsolete__(['_decorator', 'Animation', 'color', 'Component', 'Enum', 'EventTouch', 'instantiate', 'Layers', 'Material', 'Node', 'Size', 'sp', 'Sprite', 'SpriteFrame', 'Tween', 'tween', 'UIRenderer', 'UITransform', 'v3', 'Vec3']);
      ...
      _export("Thing", Thing = (_dec = ccclass('Thing'), _dec2 = property({
        type: Enum(_crd && SoundType === void 0 ? (_reportPossibleCrUseOfSoundType({
          error: Error()
        }), SoundType) : SoundType),
      ...
      }), _dec(_class = (_class2 = class Thing extends (_crd && PoolMember === void 0 ? (_reportPossibleCrUseOfPoolMember({
        error: Error()
        ...
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "sfx", _descriptor3, this);

          _initializerDefineProperty(this, "audio", _descriptor4, this);
        }

        make() {
          var _ins$getComponent2, _this$node$children$, _this$node$children$2, _this$node$getCompone2, _ins2$getComponent, _this$node$children$3, _this$node$children$4;
          ...
          try {
            if (this.node.children[0].getComponent(Sprite)) {
              ...
              if (!this.node.children[1]) {
                let ins = instantiate(this.node.children[0]);
              ...
              if (!this.node.children[2]) {
                var _ins$getComponent, _this$node$getCompone;

                let ins = instantiate(this.node);
                ins.parent = this.node;
                ins.destroyAllChildren();
          ...
          ins.parent = this.node;
          ins.position = v3(0, 0, 0);
          (_ins$getComponent2 = ins.getComponent(Thing)) == null ? void 0 : _ins$getComponent2.destroy();
          ...
          let ins2 = instantiate(this.node.children[0]);
          ins2.parent = this.node;
          ins2.position = v3(0, 0, 0);
          (_ins2$getComponent = ins2.getComponent(Thing)) == null ? void 0 : _ins2$getComponent.destroy();
          ...
          this.node.children[0].name = "SpBg" + this.node.name;
          this.node.children[1].name = "SpRender" + this.node.name;
          let uit = this.node.children[0].getComponent(UITransform);
          uit.width *= 1.1;
          uit.height *= 1.1;
        }
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "sfx", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "audio", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
          return (_crd && SoundType === void 0 ? (_reportPossibleCrUseOfSoundType({
            error: Error()
          }), SoundType) : SoundType).Hen;
        }
      })), _class2)) || _class));
...
//# sourceMappingURL=23219e093a5abfa9a77d48a7bee3282c0f87e956.js.map