        ...
        updateVisibleShadows() {
          ...
          for (const node of shadowSrc) {
            ...
            if (this.currentBatchItems.indexOf(item) >= 0) {
              ...
              (_item$itemGraphic = item.itemGraphic) == null || _item$itemGraphic.handleTargetSprites(item.targetPoint, true);
            } else {
...
//# sourceMappingURL=26d7917c1b59fdd1dc0420ca75711472df53b4ae.js.map