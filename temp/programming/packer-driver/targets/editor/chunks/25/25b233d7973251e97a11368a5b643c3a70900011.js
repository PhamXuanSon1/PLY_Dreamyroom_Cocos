System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Label, Sprite, sys, InputManager, InputPriority, ItemManager, BallFollowFill, TweenUtil, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _class3, _crd, ccclass, property, UIManager;
    ...
    execute: function () {
      ...
      _export("UIManager", UIManager = (_dec = ccclass('UIManager'), _dec2 = property({
        ...
        checkEndGame() {
          ...
          const arrived = (_im$arrivedItemCount = im == null ? void 0 : im.arrivedItemCount) != null ? _im$arrivedItemCount : this.tuSo;

          if (this.tuSo >= this.mauSo || arrived >= this.endGameCount) {
            this.isGameEnded = true;
            (_crd && InputManager === void 0 ? (_reportPossibleCrUseOfInputManager({
              error: Error()
            }), InputManager) : InputManager).canInput = false;
            ...
            if (im) {
              for (const c of im.WinConfetti) if (c != null && c.isValid) c.active = true;
            } // Cho phép chạm để mở store


            (_crd && InputManager === void 0 ? (_reportPossibleCrUseOfInputManager({
              error: Error()
            }), InputManager) : InputManager).canInput = true;
          }
        }
...
//# sourceMappingURL=25b233d7973251e97a11368a5b643c3a70900011.js.map