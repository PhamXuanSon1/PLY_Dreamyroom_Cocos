    ...
    execute: function () {
      ...
      _export("SceneBuilder", SceneBuilder = (_dec = ccclass('SceneBuilder'), _dec2 = executeInEditMode(true), _dec3 = menu('Pipeline/SceneBuilder'), _dec4 = property({
        ...
        async build() {
          ...
          console.log(`[SceneBuilder] Dựng xong "${data.meta.scene}"` + `${data.meta.exportRoot ? ` (nhánh ${data.meta.exportRoot})` : ''}` + `: ${this.nodeMap.size} node, K=${K}`);
        ...
        loadFramesFromResources() {
          return new Promise(resolve => {
            resources.loadDir(this.spriteDir, SpriteFrame, (err, assets) => {
              ...
              console.log(`[SceneBuilder] Đã load ${assets.length} SpriteFrame từ resources/${this.spriteDir}`);
              resolve();
            });
          });
        }
        ...
        async loadFramesFromAssetDb() {
          ...
          const pattern = `db://assets/resources/${this.spriteDir}/**/*`;
          let infos = [];
...
//# sourceMappingURL=7269db4022d98533b42ab6254c9e33d57fff721a.js.map