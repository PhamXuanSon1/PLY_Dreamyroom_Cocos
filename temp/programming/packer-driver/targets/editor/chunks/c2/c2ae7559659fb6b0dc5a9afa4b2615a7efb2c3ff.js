    ...
    execute: function () {
      ...
      _export("AutoAssignByNameTool", AutoAssignByNameTool = (_dec = ccclass('AutoAssignByNameTool'), _dec2 = executeInEditMode(true), _dec3 = menu('Pipeline/AutoAssignByNameTool'), _dec4 = property({
        ...
        assignTarget() {
          ...
          const targetDict = new Map();

          const collectTargets = parent => {
          ...
          const processItems = parent => {
            for (const item of parent.children) {
              const itemController = item.getComponent(_crd && ItemController === void 0 ? (_reportPossibleCrUseOfItemController({
                error: Error()
          ...
          const collectNames = parent => {
            for (const item of parent.children) {
              ...
              if (itemController) {
                ...
                const list = (_nameDict$get = nameDict.get(item.name)) != null ? _nameDict$get : [];
                list.push(item);
...
//# sourceMappingURL=c2ae7559659fb6b0dc5a9afa4b2615a7efb2c3ff.js.map