      ...
      _export("BaseRoomManager", BaseRoomManager = (_dec = ccclass('BaseRoomManager'), _dec2 = property({
        ...
        onLoad() {
          ...
          if (this.BaseRoom) {
            ...
            const room = this.BaseRoom.getComponent(_crd && BaseRoom === void 0 ? (_reportPossibleCrUseOfBaseRoom({
              error: Error()
            }), BaseRoom) : BaseRoom);
...
//# sourceMappingURL=507ac62a2336ddef12ad47c8160749edae219716.js.map