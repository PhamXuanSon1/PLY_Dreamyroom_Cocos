  ...
  return {
    ...
    execute: function () {
      ...
      _export("SoundManager", SoundManager = (_dec = ccclass('DreamySoundManager'), _dec2 = property({
        ...
        playClip(clip, volume = 1) {
          if (this.muted || !clip) return;
          const src = this.sources[this.nextSource];
          this.nextSource = (this.nextSource + 1) % Math.max(1, this.sources.length);
          src == null || src.playOneShot(clip, volume);
        }
        /** Unity: PlayLoopFx */


        playLoopFx(type, volume = 1) {
        ...
        mute() {
          ...
          this.muted = true;
          (_this$bgmSource = this.bgmSource) == null || _this$bgmSource.stop();
        ...
        unmute() {
          ...
          this.muted = false;
          if (this.unlocked) (_this$bgmSource2 = this.bgmSource) == null || _this$bgmSource2.play();
        }
...
//# sourceMappingURL=50f7c276ac7841887150192a6ad7fb98e67520ef.js.map