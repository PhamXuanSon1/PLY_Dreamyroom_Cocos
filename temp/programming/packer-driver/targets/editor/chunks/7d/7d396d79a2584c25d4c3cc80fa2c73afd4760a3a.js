System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Material, v3, Vec3, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, Mats;
  ...
  function AdjustSaturation(color, sat) {
    let gray = Vec3.dot(color, v3(0.299, 0.587, 0.114)); // return mix(vec3(gray), color, sat);
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Mats", Mats = (_dec = ccclass('Mats'), _dec2 = property([Material]), _dec3 = property({
        ...
        changeColor() {
          console.log("set color to mats"); // this.mats.forEach((m, i) => {
...
//# sourceMappingURL=7d396d79a2584c25d4c3cc80fa2c73afd4760a3a.js.map