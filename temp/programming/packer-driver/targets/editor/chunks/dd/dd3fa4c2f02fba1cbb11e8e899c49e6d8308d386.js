  ...
  return {
    ...
    execute: function () {
      ...
      _export("Tool", Tool = (_dec = ccclass('Tool'), _dec(_class = (_class2 = class Tool extends Component {
        ...
        onKeyDown(event) {
          let length = (_crd && colors === void 0 ? (_reportPossibleCrUseOfcolors({
            error: Error()
        ...
        savePNG(data, width, height, name) {
          ...
          const imgData = ctx.createImageData(width, height); // đảo Y vì GPU ngược
...
//# sourceMappingURL=dd3fa4c2f02fba1cbb11e8e899c49e6d8308d386.js.map