System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Vec3, BoxCollider2D, Vec2, InputManager, InputPriority, ItemGraphic, ItemMovement, OpenItem, ItemManager, WorldScrollManager, SeatHandler, TurnOnSpine, ChangeLight, ObjectPool, PoolType, BlinkEffect, sm, SoundType, DreamySoundManager, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, ItemController;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Vec3', 'EventTouch', 'BoxCollider2D', 'UITransform', 'Vec2']);
      ...
      _export("ItemController", ItemController = (_dec = ccclass('ItemController'), _dec2 = property({
        ...
        tooltip: 'Tên FxType phát thêm (nếu dùng DreamySoundManager, vd "Grass", "Cloth").'
          ...
          this.itemMovement.moveToTarget(target, this.moveDuration, () => {
            ...
            if (this.materialType) {
              ...
              (_instance4 = (_crd && DreamySoundManager === void 0 ? (_reportPossibleCrUseOfDreamySoundManager({
                error: Error()
              }), DreamySoundManager) : DreamySoundManager).instance) == null ? void 0 : _instance4.playFx(this.materialType);
            ...
            (_crd && InputManager === void 0 ? (_reportPossibleCrUseOfInputManager({
              error: Error()
            }), InputManager) : InputManager).unregister(this); // 5. Ẩn item đi (hình ảnh ở Target đã hiện lên thay thế)
...
//# sourceMappingURL=e7335d2c5282c037f4bf4692e5957dfedb6aef5a.js.map