System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  function getNeightbors(grid, mapSize, condition = () => false) {
    let neighbors = [];
    let directions = [new Vec2(0, 1), // Up
    new Vec2(1, 0), // Right
    new Vec2(0, -1), // Down
    new Vec2(-1, 0) // Left
    // new Vec2(0, 2),   // Up
    ...
    for (let dir of directions) {
      ...
      if (!checkOutOfBounds(neighbor, mapSize)) {
        ...
        if (condition && condition(neighbor)) {
          ...
          let neighbor2 = grid.clone().add(dir2); // if (!checkOutOfBounds(neighbor2, mapSize)) {
    ...
    execute: function () {
      ...
      BinaryHeap = class BinaryHeap {
        ...
        update(item) {
          ...
          const index = (_item$heapIndex = item.heapIndex) != null ? _item$heapIndex : -1;
          if (index < 0) return;
          this.bubbleUp(index);
          ...
          const check = () => {
            ...
            if (this.still) {
              ...
              if (current.id === endId) {
                ...
                let end = performance.now(); // console.log("Time",end-begin, count, this.path.length);
...
//# sourceMappingURL=7e221e296bcc2c96e4941371d6e91bda9e387d41.js.map