    ...
    execute: function () {
      ...
      _export("ItemManager", ItemManager = (_dec = ccclass('ItemManager'), _dec2 = property({
        ...
        start() {
          ...
          this.scheduleOnce(() => {
            const scroll = (_crd && WorldScrollManager === void 0 ? (_reportPossibleCrUseOfWorldScrollManager({
              error: Error()
        ...
        update(dt) {
          ...
          const isListEmpty = this.spawnFromLast ? this.currentItemIndex < 0 : this.currentItemIndex >= this.itemList.length;
          if (isListEmpty) (_instance2 = (_crd && BoxManager === void 0 ? (_reportPossibleCrUseOfBoxManager({
            error: Error()
          }), BoxManager) : BoxManager).instance) == null ? void 0 : _instance2.handleEmptyItems();
        } // ======================================================== shadow batch
        ...
        updateVisibleShadows() {
          ...
          const shadowSrc = this.shadowList && this.shadowList.length > 0 ? this.shadowList : this.itemList; // 1. Dọn item đã ghép khỏi đợt hiện tại
          ...
          if (this.currentBatchItems.length === 0) {
            for (const node of shadowSrc) {
              ...
              const item = node.getComponent(_crd && ItemController === void 0 ? (_reportPossibleCrUseOfItemController({
                error: Error()
          ...
          for (const node of shadowSrc) {
            ...
            if (this.currentBatchItems.indexOf(item) >= 0) {
              ...
              (_item$itemGraphic = item.itemGraphic) == null ? void 0 : _item$itemGraphic.handleTargetSprites(item.targetPoint, true);
            } else {
        ...
        enableFirstClickObjects() {
          ...
          for (const o of this.objsToEnableOnFirstClick) if (o != null && o.isValid) o.active = true;

          for (const o of this.objsToDisableOnFirstClick) if (o != null && o.isValid) o.active = false;
        } // ======================================================== item / holder
        ...
        getCurrentHolder() {
          for (const h of this.holderItemList) {
            const slot = h == null ? void 0 : h.getComponent(_crd && HolderSlot === void 0 ? (_reportPossibleCrUseOfHolderSlot({
              error: Error()
        ...
        getFirstItemInHolder() {
          for (const h of this.holderItemList) {
            ...
            if (slot && !slot.isEmpty && slot.itemInSlot) {
              const ic = slot.itemInSlot.getComponent(_crd && ItemController === void 0 ? (_reportPossibleCrUseOfItemController({
                error: Error()
              }), ItemController) : ItemController);
        ...
        itemArrivedAtTarget() {
          ...
          const ui = (_crd && UIManager === void 0 ? (_reportPossibleCrUseOfUIManager({
            error: Error()
        ...
        canUseItemHint(item) {
          ...
          const seat = item.getComponent(_crd && SeatHandler === void 0 ? (_reportPossibleCrUseOfSeatHandler({
            error: Error()
        ...
        getValidHintItem() {
          ...
          const items = (_instance$getActiveIt2 = (_instance4 = (_crd && WorldScrollManager === void 0 ? (_reportPossibleCrUseOfWorldScrollManager({
            error: Error()
...
//# sourceMappingURL=1969a869cf3f7b73a45377d7302e79bbdb683467.js.map