System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Pool", Pool = class Pool {
        constructor(root, prefab, amount) {
          ...
          for (let i = 0; i < amount; i++) {
            let clone = instantiate(prefab).getComponent(_crd && PoolMember === void 0 ? (_reportPossibleCrUseOfPoolMember({
              error: Error()
      ...
      _export("PoolAmount", PoolAmount = (_dec = property(Node), _dec2 = property(Prefab), _dec3 = property(CCInteger), ccclass(_class2 = (_class3 = class PoolAmount {
        constructor() {
      ...
      }, (_descriptor = _applyDecoratedDescriptor(_class3.prototype, "root", [_dec], {
        configurable: true,
        enumerable: true,
        writable: true,
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class3.prototype, "prefab", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class3.prototype, "amount", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      _export("PoolManager", PoolManager = (_dec4 = executeInEditMode(true), _dec5 = property(_crd && PoolControl === void 0 ? (_reportPossibleCrUseOfPoolControl({
        error: Error()
      }), PoolControl) : PoolControl), ccclass(_class5 = _dec4(_class5 = (_class6 = class PoolManager extends Component {
        constructor(...args) {
          super(...args);
        ...
        preLoad(poolAmounts) {
          for (let i = 0; i < poolAmounts.length; i++) {
            ...
            let pool = new Pool(poolAmount.root, poolAmount.prefab, poolAmount.amount);
            let type = instantiate(poolAmount.prefab).getComponent(_crd && PoolMember === void 0 ? (_reportPossibleCrUseOfPoolMember({
              error: Error()
        ...
        spawn(type, position = v3(), rotation = Quat.fromEuler(new Quat(), 0, 0, 0)) {
          let pool = this.link.get(type);
          return pool.spawn(position, rotation);
        }

        spawnType(type, position = v3(), rotation = Quat.fromEuler(new Quat(), 0, 0, 0)) {
          let pool = this.link.get(type); // console.log('pool', pool, type);    
      ...
      }, (_descriptor4 = _applyDecoratedDescriptor(_class6.prototype, "poolControll", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=d1d54d92cfdc2650bbe61e9a86f060c9326d1bbc.js.map