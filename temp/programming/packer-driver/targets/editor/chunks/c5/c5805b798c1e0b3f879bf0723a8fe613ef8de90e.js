System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Vec3, Camera, math, ItemController, DreamyInputManager, InputPriority, TweenUtil, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _class3, _crd, ccclass, property, WorldScrollManager;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      DreamyInputManager = _unresolved_3.DreamyInputManager;
      ...
      _export("WorldScrollManager", WorldScrollManager = (_dec = ccclass('WorldScrollManager'), _dec2 = property({
        ...
        setupItems(items) {
          ...
          for (const node of items) {
            ...
            node.active = true;
            const targetY = this.itemAnchor ? this.itemAnchor.worldPosition.y : node.worldPosition.y;
        ...
        itemReturned(item) {
          ...
          this.currentDraggedItem = null;
          this.reorganizeList(true);
          const baseX = (_this$itemBaseX$get = this.itemBaseX.get(item)) != null ? _this$itemBaseX$get : item.node.worldPosition.x;
          const p = item.node.worldPosition;
          const targetY = this.itemAnchor ? this.itemAnchor.worldPosition.y : p.y;
          ...
          (_crd && TweenUtil === void 0 ? (_reportPossibleCrUseOfTweenUtil({
            ...
            (_item$itemGraphic = item.itemGraphic) == null || _item$itemGraphic.restoreOriginalLayers();
          });
          const g = item.itemGraphic;
...
//# sourceMappingURL=c5805b798c1e0b3f879bf0723a8fe613ef8de90e.js.map