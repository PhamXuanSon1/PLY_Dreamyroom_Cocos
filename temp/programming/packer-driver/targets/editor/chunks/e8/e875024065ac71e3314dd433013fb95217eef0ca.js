      ...
      _export("Mats", Mats = (_dec = ccclass('Mats'), _dec2 = property([Material]), _dec3 = property({
        ...
        changeColor() {
          ...
          this.mats.forEach((m, i) => {
            let c = (_crd && colors === void 0 ? (_reportPossibleCrUseOfcolors({
              error: Error()
            ...
            let a = (_crd && colors === void 0 ? (_reportPossibleCrUseOfcolors({
              error: Error()
            }), colors) : colors)[i].clone();
            let dt = 150;
...
//# sourceMappingURL=e875024065ac71e3314dd433013fb95217eef0ca.js.map